...
function submitTxt(){
  ...
  if(artitle_title.value==''){
    ...
    xhr.send("class_id="+encodeURIComponent(classid.value)+"&title="+encodeURIComponent(artitle_title.value)+"&body="+encodeURIComponent(article_content)+"&body_html="+encodeURIComponent(article_content_html)+"&secret="+encodeURIComponent(secret.value));
